...
let browser, page
const appPath = 'http://localhost/sider/annet/Ranking-app/'
// const appPath = 'http://localhost/sider/annet/Ranking-app/list.html?list=1'
...
test('if user can create item', async () => {
  ...
  console.log('preCreatedLis.length: ', preCreatedLis.length)
  ...
  console.log('postCreatedLis.length: ', postCreatedLis.length)
